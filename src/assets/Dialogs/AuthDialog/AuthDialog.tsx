  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isLogin) {
      ...
      if (!passwordRegex.test(formData.password)) {
        setPasswordError(
          "Password should have at least 8 characters, with 1 uppercase letter, 1 lowercase letter, 1 digit, and 1 special character!",
        );
        return;
      }
      ...
      showToast("Failed to register. Please check your details and try again.", "error");
    }
    }
  };
